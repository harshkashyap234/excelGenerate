...
public class CommonConfig {
    ...
    public  static LinkedHashMap<String, StaticMapProperties> communicationFee(){
        ...
        flattenNameByProperty.put("chargeSubType.", new StaticMapProperties(true, "Service Type"));
        flattenNameByProperty.put("courierAwbNo.", new StaticMapProperties(true, "Courier Awb No"));
        flattenNameByProperty.put("chargeDetails.chargeType.", new StaticMapProperties(true, "Charge Type"));
        flattenNameByProperty.put("billingPeriodId.", new StaticMapProperties(true, "Billing Period Id"));
        flattenNameByProperty.put("totalCharges.currencyCode.", new StaticMapProperties(true, "Total Charges"));
        flattenNameByProperty.put("totalCharges.amount.", new StaticMapProperties(true, "Total Charges"));
        flattenNameByProperty.put("gstPercentage.", new StaticMapProperties(true, "Gst Percentage"));
        flattenNameByProperty.put("totalChargesWithGst.amount.", new StaticMapProperties(true, "Total Charges (With Gst)"));
    ...
    public  static LinkedHashMap<String, StaticMapProperties> fullfillmentFee(){
        ...
        flattenNameByProperty.put("transactionReference.", new StaticMapProperties(true, "Transaction Reference"));
        flattenNameByProperty.put("chargeSubType.", new StaticMapProperties(true, "Service Type"));
        flattenNameByProperty.put("courierAwbNo.", new StaticMapProperties(true, "Courier Awb"));
        flattenNameByProperty.put("chargeDetails.chargeType.", new StaticMapProperties(true, "Charge Type"));
        flattenNameByProperty.put("chargeDetails.shipmentValue.currencyCode.", new StaticMapProperties(true, "Currency Code"));
        flattenNameByProperty.put("chargeDetails.shipmentValue.amount.", new StaticMapProperties(true, "Shipment Value Amount"));
        flattenNameByProperty.put("chargeDetails.shipmentCreationDate.", new StaticMapProperties(true, "Shipment Creation Date"));
        flattenNameByProperty.put("chargeDetails.sourcePincode.", new StaticMapProperties(true, "Source Pincode"));
        flattenNameByProperty.put("chargeDetails.sourceCity.", new StaticMapProperties(true, "Source City"));
        flattenNameByProperty.put("chargeDetails.destinationPincode.", new StaticMapProperties(true, "Destination Pincode"));
        flattenNameByProperty.put("chargeDetails.destinationCity.", new StaticMapProperties(true, "Destination City"));
        flattenNameByProperty.put("chargeDetails.zone.", new StaticMapProperties(true, "Zone"));
        flattenNameByProperty.put("chargeDetails.courierCode.", new StaticMapProperties(true, "Courier Code"));
        flattenNameByProperty.put("chargeDetails.deadWeight.", new StaticMapProperties(true, "Dead Weight"));
        flattenNameByProperty.put("chargeDetails.volumeWeight.", new StaticMapProperties(true, "Volume Weight"));
        flattenNameByProperty.put("chargeDetails.chargedWeight.", new StaticMapProperties(true, "Charged Weight"));
        flattenNameByProperty.put("chargeDetails.weightSlab.", new StaticMapProperties(true, "Weight Slab"));
        flattenNameByProperty.put("chargeDetails.shipmentType.", new StaticMapProperties(true, "Shipment Type"));
        flattenNameByProperty.put("chargeDetails.paymentMode.", new StaticMapProperties(true, "Payment Mode"));
        flattenNameByProperty.put("chargeDetails.freightCharges.currencyCode.", new StaticMapProperties(true, "Currency Code"));
        flattenNameByProperty.put("chargeDetails.freightCharges.amount.", new StaticMapProperties(true, "Freight Charges Amount"));
        flattenNameByProperty.put("chargeDetails.codCharges.currencyCode.", new StaticMapProperties(true, "Currency Code"));
        flattenNameByProperty.put("chargeDetails.codCharges.amount.", new StaticMapProperties(true, "Cod Charges Amount"));
        flattenNameByProperty.put("billingPeriodId.", new StaticMapProperties(true, "Billing Period Id"));
        flattenNameByProperty.put("totalCharges.currencyCode.", new StaticMapProperties(true, "Currency Code"));
        flattenNameByProperty.put("totalCharges.amount.", new StaticMapProperties(true, "Total Charges Amount"));
        flattenNameByProperty.put("gstPercentage.", new StaticMapProperties(true, "Gst Percentage"));
        flattenNameByProperty.put("totalChargesWithGst.currencyCode.", new StaticMapProperties(true, "Currency Code"));
        flattenNameByProperty.put("totalChargesWithGst.amount.", new StaticMapProperties(true, "Total Charges ( With Gst )"));
        return flattenNameByProperty;
    }
    @Bean
    public  static LinkedHashMap<String, StaticMapProperties> subscriptionFee(){
        ...
        flattenNameByProperty.put("chargeSubType.", new StaticMapProperties(true, "Service Type"));
        flattenNameByProperty.put("chargeDetails.chargeType.", new StaticMapProperties(true, "Charge Type"));
        flattenNameByProperty.put("chargeDetails.activationDate.", new StaticMapProperties(true, "Activation Date"));
        flattenNameByProperty.put("chargeDetails.endDate.", new StaticMapProperties(true, "End Date"));
        flattenNameByProperty.put("billingPeriodId.", new StaticMapProperties(true, "Billing Period Id"));
        flattenNameByProperty.put("totalCharges.currencyCode.", new StaticMapProperties(true, "Currency Code"));
        flattenNameByProperty.put("totalCharges.amount.", new StaticMapProperties(true, "Total Charges"));
        flattenNameByProperty.put("gstPercentage.", new StaticMapProperties(true, "Gst Percentage"));
    ...
    public  static LinkedHashMap<String, StaticMapProperties> registrationFee(){
        ...
        flattenNameByProperty.put("transactionReference.", new StaticMapProperties(true, "Transaction Reference"));
        flattenNameByProperty.put("chargeDetails.chargeType.", new StaticMapProperties(true, "Charge Type"));
        flattenNameByProperty.put("chargeDetails.platformName.", new StaticMapProperties(true, "Platform Name"));
        flattenNameByProperty.put("chargeDetails.liveDate.", new StaticMapProperties(true, "Live Date"));
        flattenNameByProperty.put("billingPeriodId.", new StaticMapProperties(true, "Billing Period Id"));
    ...
    public  static LinkedHashMap<String, StaticMapProperties> managedServiceFee(){
        ...
        flattenNameByProperty.put("transactionReference.", new StaticMapProperties(true, "Transaction Reference"));
        flattenNameByProperty.put("chargeDetails.chargeType.", new StaticMapProperties(true, "Charge Type"));
        flattenNameByProperty.put("chargeDetails.orderValue.amount.", new StaticMapProperties(true, "Charge Details Amount"));
        flattenNameByProperty.put("chargeDetails.percentageFee.", new StaticMapProperties(true, "Percentage Fee"));
        flattenNameByProperty.put("billingPeriodId.", new StaticMapProperties(true, "Billing Period Id"));
        flattenNameByProperty.put("totalCharges.currencyCode.", new StaticMapProperties(true, "Total Charges Currency Code"));
        flattenNameByProperty.put("totalCharges.amount.", new StaticMapProperties(true, "Total Charges Amount"));
        flattenNameByProperty.put("totalChargesWithGst.amount.", new StaticMapProperties(true, "Total Charges (With Gst)"));
